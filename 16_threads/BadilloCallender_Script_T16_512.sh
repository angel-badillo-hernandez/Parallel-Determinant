...
# Parallel (16, 512) Frontera script

#SBATCH -J myparalleljob_16_512           # Job name
#SBATCH -o myparalleljob_16_512.o%j       # Name of stdout output file
#SBATCH -e myparalleljob_16_512.e%j       # Name of stderr error file
...
g++ BadilloCallender_T16_512.cpp -lpthread -o parallel_16_512
...
for value in {1..3}
do
    ./parallel_16_512       # Use ibrun instead of mpirun or mpiexec
    echo ''              # newline
done
